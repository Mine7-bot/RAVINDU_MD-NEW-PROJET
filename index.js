...
const port = process.env.PORT || 9090;
  ...
  console.log('Successfully Send Massage bot Owner✅')
  console.log('RAVINDU MD bot Successfully Runing severs🚀')
  
  async function joinGroupFromJson() {
    try {
        let joinlink2 = await fetchJson('zip.json');
        ...
        const joinlink = joinlink2.join.split('https://chat.whatsapp.com/C5IaTCexCii4CA4XUYt4Ff')[1]; // Extract invite code
...
*ᴛʜᴀɴᴋꜱ ꜰᴏʀ ᴜꜱɪɴɢ ʀᴀᴠɪɴᴅᴜ-ᴍᴅ Wʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ* ❤`;
    conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/df375f.jpg` }, caption: up })
  }
  })
  ...
  const udp = botNumber.split('@')[0];
    const jawad = ('94763079634', '94702041294', '94763079634');
